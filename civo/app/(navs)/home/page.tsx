...
export default function HomePage() {
    return(
        <div className='relative w-full h-screen overflow-hidden px-[20px] z-20'> 
            ...
            <div id="searchfield" className="mt-[107.91px] pt-[8px] pb-[7px] pl-[8px] pr-[8px] h-[36px] w-full z-20 bg-white rounded-[10px] drop-shadow-[0_2px_6px_rgba(0,0,0,0.15)] flex gap-[8px] pointer-events-auto">
