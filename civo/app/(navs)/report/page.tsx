...
export default function ReportPage() {
    return(
        <div className="w-full h-full px-[20px] z-20 bg-white pointer-events-auto flex flex-col gap-[10px] shrink-0">
            ...
            <Link href="/report/incident" className="relative mt-[10px] h-[235px] px-[18px] py-[11px] w-full text-right text-white">
            ...
            <div className="relative h-[140px] px-[18px] py-[11px] w-full text-right text-white">
