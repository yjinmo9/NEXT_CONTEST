      ...
      <div className="mt-[5px] flex-grow overflow-y-auto min-h-0 flex flex-col gap-[32px]">
        <div id="파손신고 제목">
          <Label htmlFor="title" className="font-semibold text-[15px]">
            파손신고 제목 <span className="text-red-700">*</span>
          </Label>
          <Input
            name="title"
        ...
        <div id="파손 내용" className="flex flex-col">
          <Label htmlFor="content" className="font-semibold text-[15px]">
            파손 내용 <span className="text-red-700">*</span>
          </Label>
          <TextareaAutosize
        ...
        <button
          ...
          className={`h-[53px] rounded-[10px] w-full text-sm transition ${
            isValid
              ? 'bg-black text-white'
              : 'bg-gray-300 text-black font-semibold cursor-not-allowed'
          }`}
        >
          다음
        </button>
